...
```
STORJ_BRIDGE=http://91.121.64.34:8080 ./src/storj register
```

And then check your email and activate the account, and then add buckets and files:

```
STORJ_BRIDGE=http://91.121.64.34:8080 ./src/storj add-bucket
STORJ_BRIDGE=http://91.121.64.34:8080 ./src/storj upload-file <bucket_hash> <filename>
STORJ_BRIDGE=http://91.121.64.34:8080 ./src/storj download-file <bucket_hash> <file_hash>
```
